...
export const users: User[] = [
  { id: 'user-1', name: 'Amelia', avatarUrl: getUserAvatar('user-1'), online: true },
  { id: 'user-2', name: 'Ben', avatarUrl: getUserAvatar('user-2'), online: true },
  { id: 'user-3', name: 'Clara', avatarUrl: getUserAvatar('user-3'), online: false },
  { id: 'user-4', name: 'David', avatarUrl: getUserAvatar('user-4'), online: true },
  { id: 'user-5', name: 'You', avatarUrl: getUserAvatar('user-5'), online: true },
  { id: 'user-6', name: 'Emily', avatarUrl: getUserAvatar('user-6'), online: false },
  { id: 'user-7', name: 'Frank', avatarUrl: getUserAvatar('user-7'), online: true },
];
...
export const channels: Channel[] = [
  ...
  },
  {
    ...
    members: ['user-1', 'user-3', 'user-6', 'user-5'],
    type: 'private',
    automations: [],
  },
];
...
export const messages: Message[] = [
  ...
  },
  {
    ...
    channelId: 'channel-2',
    authorId: 'user-4',
    content: 'Just saw the funniest cat video! 😂 Has to be shared.',
    ...
    channelId: 'channel-2',
    authorId: 'user-3',
    content: 'Haha, send it over! I need a laugh.',
    ...
    channelId: 'channel-2',
    authorId: 'user-7',
    content: "Speaking of random, has anyone tried that new coffee shop downtown? I've heard good things.",
