    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Find people to start a one-on-one chat, or create a new group channel.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6 py-4">
            ...
            <DialogFooter className="md:col-span-2 mt-4">
              ...
              <Button type="button" onClick={() => onSelectUser(selectedUsers[1])}>Start 1-on-1 Chat</Button>
              <Button type="button" onClick={handleCreate}>Create Group Chat</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
